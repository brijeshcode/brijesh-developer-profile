...
<template>
    <section class="mb-4">
        ...
        <div class="p-2 text-sm md:text-[12px] " >
            <div class="flex gap-4 mb-4 items-start" v-for="strength in strengths" :key="strength.name"> 
                    <icon-half-star v-if="strength.icon === 'half-star'" class="w-8 text-sky-600" />
                    <icon-magic-wand v-if="strength.icon === 'magic-wand'" class="w-8 text-sky-600" />
                    <icon-tick v-if="strength.icon === 'tick'" class="w-8 text-sky-600" />
                    <icon-chat v-if="strength.icon === 'chat'" class="w-8 text-sky-600" />
                <div>
